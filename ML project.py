...
st.write("")
st.write("Welcome to the Career Recommendation App!")
st.markdown("Are you ready to explore your future? This app provides career suggestions based on your marks, part-time jobs, and extracurricular activities.<br>Let’s take the first step toward discovering the career that’s right for you!", unsafe_allow_html=True)
...
if st.button('Get Career Recommendation'):
    ...
    plt.bar(subjects, scores, color='#4CAF50')                #228B22
    plt.ylim(0, 100)
